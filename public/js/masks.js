window.addEventListener('load', function() {
    ...
    const imaskDateInstance = IMask(chargeDateInput, dateMaskOptions);
    
    flatpickr(chargeDateInput, {
        dateFormat: "d/m/Y",
        locale: "pt",
        allowInput: false,
        minDate: "today",
        ...
        onClose: function (selectedDates, dateStr, instance) {
            if (selectedDates.length > 0) {
                ...
                imaskDateInstance.value = formatted;

                chargeDateInput.dispatchEvent(new Event('input', { bubbles: true }));
            }
        },

        onOpen: function (selectedDates, dateStr, instance) {
            if (imaskDateInstance.value && imaskDateInstance.value !== '__/__/____') {
                instance.setDate(imaskDateInstance.value, true);
            } else {
